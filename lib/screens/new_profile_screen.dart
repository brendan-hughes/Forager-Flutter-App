...
double iconDimensions = 70;
TextStyle birthdayHintColor = TextStyle(
  color: Colors.red,
  fontSize: 10,
);
          ...
          child: Column(
              ...
              children: [
                Column(children: [
                            ...
                            child: ListView(
                              children: [Column(
                                children: <Widget>[
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("WELCOME TO FORAGER!",
                                        style: headerText),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("Please answer the questions below to start finding food that fits.",
                                        style: descriptionTextSmall, textAlign: TextAlign.center,),
                                  ),
                                  Padding(
                                                          ...
                                                          onPressed: () async {
                                                            ...
                                                            if (datePick !=
                                                              ...
                                                              setState(() {
                                                                final birthDateData =
                                                                    datePick;
                                                                birthdayHintColor = TextStyle(color: Colors.transparent,fontSize:10);
                                                                birthDate =
                  ...
                  RaisedButton(
                    onPressed: () {
                      if (birthDate == "Add Birthday") {
                        setState(() {
                          birthdayHintColor = warningText;
                        });
                      } else {
                        setState(() {
                          birthdayHintColor = TextStyle(color: Colors.transparent,fontSize:10);
                    ...
                    child: Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            Text("Save Settings", style: descriptionText),
